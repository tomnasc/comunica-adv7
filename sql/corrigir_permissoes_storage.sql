-- Script para corrigir permissões de storage e criar bucket

-- Desabilitar temporariamente RLS na tabela de buckets
...
-- Desabilitar temporariamente RLS na tabela de objetos
